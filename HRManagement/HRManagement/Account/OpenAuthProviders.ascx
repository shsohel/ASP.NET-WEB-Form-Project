<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="HRManagement.Account.OpenAuthProviders" %>

<div id="socialLoginList">
    <h4>Use Third Party to log in.</h4>
    <hr />
